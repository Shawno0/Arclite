...
spell:words("exura")
spell:group("healing")
spell:vocation("druid;true", "elder druid;true", "arch druid;true", "paladin;true", "royal paladin;true", "holy paladin;true", "sorcerer;true", "master sorcerer;true", "magus sorcerer;true")
